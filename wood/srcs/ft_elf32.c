...
static int	parse_section_headers_32(t_elf_file *file, int *sym_link)
{
	...
	{
		elf_set(file, file->elf32_ehdr->e_shentsize , (void **)&file->elf32_shdr[i], 0);
